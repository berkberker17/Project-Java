...
public class MainTest extends BaseTest{
    ...
    public void test() throws InterruptedException {
        ...
        Assert.assertEquals(quantityProductBasket,"1");
        Log.info("Sepette 1 adet ürün bulunduğu görülür.");

        basketPage.removeAllProduct();
        String emptyBasketText= basketPage.getEmptyBasket();
        Assert.assertTrue(emptyBasketText.contains("Sepetiniz Boş"));
